public class Handphone extends Perangkat{
    ...
    public void informasi(){
        ...
        if (fingerprint == true) {
            isFingerprint = "memiliki";
        } else {
            isFingerprint = "TIDAK memiliki";
        }
        System.out.println("Handphone ini memiliki drive tipe " + drive + " dengan ram sebesar " + ram + " GB dan processor secepat " + processor + " Ghz. Selain itu handphone ini " + isFingerprint + " fingerprint.");
    }
